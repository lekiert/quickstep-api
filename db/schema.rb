...
ActiveRecord::Schema.define(version: 20170526000651) do
  ...
  create_table "exercises", id: :integer, default: -> { "nextval('exercises_id_seq'::regclass)" }, force: :cascade do |t|
    ...
    t.index ["code", "status", "name", "test_id"], name: "index_exercises_on_code_and_status_and_name_and_test_id", using: :btree
  end

  create_table "exercises_storage_files", id: :integer, default: -> { "nextval('exercises_storage_files_id_seq'::regclass)" }, force: :cascade do |t|
